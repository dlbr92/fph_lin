...
# df2 = pd.DataFrame({
#     'Regularização': uhe['tipo_reg'],
#     'Vmin': uhe['vol_min'],
#     'Vmax': uhe['vol_max'],
#     'VVert': uhe['vol_vert'],
#     'Vdes': uhe['vol_min_desv'],
#     'Tipo de Turbina': uhe['tipo_turb'],
#     'Prod. Específica': uhe['prod_esp'],
#     'Infl. Canal de Fuga': uhe['inf_canal_fuga'],
#     'Perdas': uhe['perda_hid'],
# })
